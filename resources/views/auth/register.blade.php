            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="numTlf" class="col-md-4 col-form-label text-md-end">{{ __('Número de teléfono') }}</label>

                            <div class="col-md-6">
                                <input id="numTlf" type="text" class="form-control @error('numTlf') is-invalid @enderror" name="numTlf" value="{{ old('numTlf') }}" required autocomplete="numTlf" autofocus>
